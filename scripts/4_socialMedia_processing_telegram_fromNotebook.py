...
full_df_raw = pd.read_csv(f"../data/processed/{platformID}/{gam_info['file_timeinfo']}_{platformID}_uniqueViewer_country.csv")
...
- Reach
'''
print(full_df_raw.shape)

full_df = full_df_raw.merge(country_codes, on='PlaceID', 
